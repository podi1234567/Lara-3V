...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "LNIHhAaI#kKpZamRzOGmYSUjpocP0RSocJlxfySR6wMBAKhsCcVs", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94743689139",
DEV: process.env.DEV || "94743689139",
